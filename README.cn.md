...
[![x-cmd/install — mq Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/mq.svg?lang=zh)](https://x-cmd.com/install/mq)
...
合计: **199,113** 行代码（覆盖前 5 种语言、共 **349** 个文件）。
...
- **Star**: 1,036 · **Fork**: 22 · **开放 issue**: 201 · **贡献者**: 10

## 累计统计

- **发布数**: 82 · **已合并 PR**: 2109 · **开放 PR**: 4 · **已关闭 issue**: 192 · **开放 issue**: 9 · **提交数**: 7002
...
_数据快照: `data/card/260926.yml` · 2026-09-26T06:10:34Z._
