...
合计: **196,018** 行代码（覆盖前 5 种语言、共 **345** 个文件）。
...
- **发布数**: 80 · **已合并 PR**: 1994 · **开放 PR**: 4 · **已关闭 issue**: 189 · **开放 issue**: 12 · **提交数**: 6605
...
在 [repology.org](https://repology.org/project/mq) 上共有 **4** 个发行版报告此项目。**2** 个 ✅ 已是最新上游版本，**1** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260913.yml` · 2026-09-13T06:28:21Z._
